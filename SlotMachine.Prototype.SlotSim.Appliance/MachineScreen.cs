...
namespace SlotMachine.Prototype.SlotSim.Appliance
{
    ...
    public class MachineScreen : Screen
    {
        ...
        public const int STARTING_CREDITS = 100;
        private bool spinToggle = false;

        /// <summary>
        /// Constructor for this screen as stand along game
        /// </summary>
        public MachineScreen(ScreenCompleteDelegate<Screen, Screen> screenComplete, GraphicsDeviceManager graphics)
            : base(null, graphics, "SlotMachineScreen")
        {
            this.ScreenComplete = screenComplete;

            this.DataStore = new SlotSimDataStore("SlotSimDataStore");
            ...
            var tempDb = new SlotSimDatabaseXML(this.DataStore, "TempDBLog");
            tempDb.Initialize();
        ...
        /// </summary>
        public MachineScreen(ScreenCompleteDelegate<Screen, Screen> screenComplete, SlotSimDataStore dataStore, GraphicsDeviceManager graphics)
